 ...
 * @author Sutra Zhou
 */
public class ConsumerServlet_openid_096 extends javax.servlet.http.HttpServlet {
        ...
        private static final Log LOG = LogFactory.getLog(ConsumerServlet_openid_096.class);
        ...
        public void init(ServletConfig config) throws ServletException {
                ...
                manager.setConnectTimeout(10000); //<-- IMPACT EDIT
                manager.setSocketTimeout(10000); //<-- IMPACT EDIT
        ...
        protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        	...
        	try{
        		...
        		req.getSession().setAttribute("message", "OpenIDException occured:<br>"+e.getMessage()); //<-- IMPACT EDITS
    			this.getServletContext().getRequestDispatcher("/exception.jsp").forward(req, resp);      //<-- IMPACT EDITS
        	}
        }
        ...
        private void receiveSimpleRegistration(HttpServletRequest httpReq,
                ...
                if (authSuccess.hasExtension(SRegMessage.OPENID_NS_SREG)) {
                        ...
                        if (ext instanceof SRegResponse) {
                                ...
                                Iterator iter = sregResp.getAttributeNames()
