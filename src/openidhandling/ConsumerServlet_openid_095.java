 ...
 * 
 */
public class ConsumerServlet_openid_095 extends javax.servlet.http.HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if ("true".equals(req.getParameter("fromopenid"))) {
			...
			System.out.println("else processReturn");
			String identifier = req.getParameter("openid_identifier");
			if (identifier != null) {
				System.out.println("identifier != null !!! == "+identifier);
				identifier=identifier.trim();
				this.authRequest(identifier, req, resp);
			} else {
				System.out.println("identifier == null");
				System.out.println("Redir login.jsp");
	...
	private void processReturn(HttpServletRequest req, HttpServletResponse resp)
		...
		if (identifier == null) {
			...
			System.out.println("Redir return.jsp");
			//openid_identifier
	...
	public String authRequest(String userSuppliedString,
		...
		try {
			...
			if (!discovered.isVersion2()) {
				...
				System.out.println("Redir formredirection.jsp");
			...
			httpReq.getSession().setAttribute("message", "OpenIDException occured:<br>"+e.getMessage());
