...
<% if (mode.equals("c4i")){ %>   
    ...
    <meta charset="UTF-8">
    <meta name="description" content="The aim of C3SMagic is to enhance the use of research data and to support other climate portals. It has been developed within the European projects IS-ENES, IS-ENES2 and CLIPC. Climate4impact is connected to the Earth System Grid Federation, using certificate based authentication, ESGF search, openid, opendap and thredds catalogs. Climate4impact offers web interfaces for searching, visualizing, analyzing, processing and downloading datasets.">
    <meta name="keywords" content="c3s-magic, SPECS, CMIP5, CMIP6, CORDEX, CLIPC, IS-ENES, WMS, WPS, WCS, ADAGUC, ICCLIM, impact, ESGF, onlineanalysis, research, webprocessing">
