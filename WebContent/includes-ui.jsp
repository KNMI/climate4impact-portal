<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="impactservice.Configuration"%>   
    ...
    <meta name="keywords" content="climateimpact, impactportal, SPECS, CMIP5, CMIP6, CORDEX, CLIPC, IS-ENES, WMS, WPS, WCS, ADAGUC, ICCLIM, impact, ESGF, onlineanalysis, research, webprocessing">
