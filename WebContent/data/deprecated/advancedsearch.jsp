			...
			<div class="bodycontent">    
				<table>
					<tr>
						...
						<%try{out.print(DrupalEditor.showDrupalContent("?q=node/8",request,response));}catch(DrupalEditor.DrupalEditorException e){out.print(e.getMessage());response.setStatus(e.getCode());}%>
            </div></td>
					</tr>
				</table>
			</div>
