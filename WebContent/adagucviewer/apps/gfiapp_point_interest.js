...
//    webmapjs.addListener("ondimchange",ondimchange,true);
   ...
   var pointOnMapClicked = function(options) {
      ...
      var lon = lalo.x.toFixed(2);
      var lat = lalo.y.toFixed(2);
      $('#webmapjs_point_interest_lon').val(lon);
      fullPointInterest.lon = lon;
      $('#webmapjs_point_interest_lat').val(lat);
      fullPointInterest.lat = lat;
